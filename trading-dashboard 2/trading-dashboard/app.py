...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        cache_age = data._get_cache_age("SPY", "ohlcv_1y")
        if cache_age:
            st.caption(f"Cache age: {cache_age:.0f} min")
        ...
        with st.form("trade_form"):
            ...
            if submitted:
                if trade_ticker and strike > 0:
                    ...
                    # Log to CSV
                    trade_log_path = os.path.join(os.path.dirname(__file__), "data", "trades_log.csv")
